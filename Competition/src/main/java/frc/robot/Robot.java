...
import frc.robot.commands.routines.RoutineRight4BF;
...
public class Robot extends TimedRobot {
  ...
  private final Command routine1leftslow = new Routine1BLeftS();
    ...
    private final Command routine4Leftfast = new RoutineLeft4BF();
    private final Command routine4Rightfast = new RoutineRight4BF();
  ...
  public void robotInit() {
    ...
    m_chooser.addOption("Routine 4 right fast", routine4Rightfast);
